...
export function bookmarkCreate(input: BookmarkCreateInput, options?: InvokeOptions): Promise<Snapshot> {
  return invokeGeneratedFields3<Snapshot>(19, 'bookmarkCreate', input, input["title"], input["url"], input["folderId"], options);
}
...
export function bookmarkFolderCreate(input: BookmarkFolderCreateInput, options?: InvokeOptions): Promise<Snapshot> {
  return invokeGeneratedFields1<Snapshot>(23, 'bookmarkFolderCreate', input, input["title"], options);
}
...
export function bookmarkFolderRemove(input: BookmarkFolderIdInput, options?: InvokeOptions): Promise<Snapshot> {
  return invokeGeneratedFields1<Snapshot>(25, 'bookmarkFolderRemove', input, input["folderId"], options);
}
bookmarkFolderRemove.commandId = 'bookmarkFolderRemove';

export const bookmarkFolderRename = createGeneratedFields2<BookmarkFolderRenameInput, Snapshot>(24, 'bookmarkFolderRename', "folderId", "title", 'bookmarkFolderRename');

export const bookmarkMove = createGeneratedFields2<BookmarkMoveInput, Snapshot>(22, 'bookmarkMove', "bookmarkId", "index", 'bookmarkMove');

export function bookmarkOpen(input: BookmarkOpenInput, options?: InvokeOptions): Promise<Snapshot> {
  return invokeGeneratedFields3<Snapshot>(28, 'bookmarkOpen', input, input["bookmarkId"], input["reuseTabId"], input["private"], options);
}
...
export function bookmarkRemove(input: BookmarkIdInput, options?: InvokeOptions): Promise<Snapshot> {
  return invokeGeneratedFields1<Snapshot>(21, 'bookmarkRemove', input, input["bookmarkId"], options);
}
bookmarkRemove.commandId = 'bookmarkRemove';

export const bookmarkSetFolder = createGeneratedFields2<BookmarkSetFolderInput, Snapshot>(26, 'bookmarkSetFolder', "bookmarkId", "folderId", 'bookmarkSetFolder');

export function bookmarkUpdate(input: BookmarkUpdateInput, options?: InvokeOptions): Promise<Snapshot> {
  return invokeGeneratedFields3<Snapshot>(20, 'bookmarkUpdate', input, input["bookmarkId"], input["title"], input["url"], options);
}
...
export function tabReset(input: TabIdInput, options?: InvokeOptions): Promise<Snapshot> {
  return invokeGeneratedFields1<Snapshot>(27, 'tabReset', input, input["tabId"], options);
}
